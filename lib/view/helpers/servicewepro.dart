                      ...
                      children: [
                        Container(
                            ...
                            child: Padding(
                              ...
                              child:index==0? Image.asset('assets/shield.png'):index==1?Image.asset('assets/shildd.png'):Image.asset('assets/code.png')
                            ),
                          ...
                          Container(
                              ...
                              width: 70,
                               child:index==0? Padding(
                                 ...
                                 padding: const EdgeInsets.all(12.0),
                                 child: Image.asset('assets/shildd.png'),
                               ):Padding(
                                 padding: const EdgeInsets.all(12.0),
                              ...
                              ,decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(25),
                                  //color: Color.fromARGB(255, 3, 73, 131),
                                  color: index==0?Colors.blue:index==1? Colors.red:Colors.black,
